...
public class leftLiftMain extends OpMode {
...
//    private Servo elbowServo;
    ...
    public void init() {
        ...
        leftBottom = leftLift.getCurrentPosition()-5650;
        leftLift.setTargetPosition(leftLift.getCurrentPosition());
        leftLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);

        rightLift.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        rightBottom = rightLift.getCurrentPosition()-5650;
        ...
        leftPosition = leftBottom + 5650;
        rightPosition = rightBottom + 5650;
    }
    ...
    public void loop() {
        ...
        handServo.setPosition(0.90-gamepad1.right_trigger*0.275);
